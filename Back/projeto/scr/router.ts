...
import { FeriadoEmpresaControllers } from './controllers/FeriadoEmpresa/FeriadoEmpresaControllers'
const router = Router()
...
router.post('/CadastrarFeriado', new FeriadoEmpresaControllers().cadastrarFeriado)
